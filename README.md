[![REUSE status](https://api.reuse.software/badge/github.com/SAP-samples/mta-job-scheduler)](https://api.reuse.software/info/github.com/SAP-samples/mta-job-scheduler)
